...
impl KeyCode {
    pub fn from_rdev(key: Key) -> Self {
        use Key::*;
        match key {
            KeyA => Self::A, KeyB => Self::B, KeyC => Self::C, KeyD => Self::D,
            KeyE => Self::E, KeyF => Self::F, KeyG => Self::G, KeyH => Self::H,
            KeyI => Self::I, KeyJ => Self::J, KeyK => Self::K, KeyL => Self::L,
            KeyM => Self::M, KeyN => Self::N, KeyO => Self::O, KeyP => Self::P,
            KeyQ => Self::Q, KeyR => Self::R, KeyS => Self::S, KeyT => Self::T,
            KeyU => Self::U, KeyV => Self::V, KeyW => Self::W, KeyX => Self::X,
            KeyY => Self::Y, KeyZ => Self::Z,

            Num0 => Self::Num0, Num1 => Self::Num1, Num2 => Self::Num2,
            Num3 => Self::Num3, Num4 => Self::Num4, Num5 => Self::Num5,
            Num6 => Self::Num6, Num7 => Self::Num7, Num8 => Self::Num8,
            Num9 => Self::Num9,
            ...
            Alt => Self::AltLeft, AltGr => Self::AltRight,
            MetaLeft => Self::MetaLeft, MetaRight => Self::MetaRight,
            CapsLock => Self::CapsLock, Function => Self::FunctionKey,

            UpArrow => Self::Up, DownArrow => Self::Down,
            LeftArrow => Self::Left, RightArrow => Self::Right,
            Home => Self::Home, End => Self::End,
            PageUp => Self::PageUp, PageDown => Self::PageDown,
            Insert => Self::Insert, Delete => Self::Delete,

            Backspace => Self::Backspace, Tab => Self::Tab,
            Return => Self::Return, Space => Self::Space, Escape => Self::Escape,

            BackQuote => Self::BackQuote, Minus => Self::Minus, Equal => Self::Equal,
            LeftBracket => Self::LeftBracket, RightBracket => Self::RightBracket,
            BackSlash => Self::BackSlash, SemiColon => Self::Semicolon,
            Quote => Self::Quote, Comma => Self::Comma, Dot => Self::Dot,
            Slash => Self::Slash, IntlBackslash => Self::IntlBackslash,

            Kp0 => Self::Kp0, Kp1 => Self::Kp1, Kp2 => Self::Kp2, Kp3 => Self::Kp3,
            Kp4 => Self::Kp4, Kp5 => Self::Kp5, Kp6 => Self::Kp6, Kp7 => Self::Kp7,
            Kp8 => Self::Kp8, Kp9 => Self::Kp9,
            KpMinus => Self::KpMinus, KpPlus => Self::KpPlus,
            KpMultiply => Self::KpMultiply, KpDivide => Self::KpDivide,
            KpReturn => Self::KpReturn, KpDelete => Self::KpDelete,

            PrintScreen => Self::PrintScreen, ScrollLock => Self::ScrollLock,
            Pause => Self::Pause, NumLock => Self::NumLock,
    ...
    pub fn is_modifier(self) -> bool {
        matches!(
            ...
            Self::ShiftLeft | Self::ShiftRight
                ...
                | Self::AltLeft | Self::AltRight
                | Self::MetaLeft | Self::MetaRight
                | Self::CapsLock | Self::FunctionKey
        )
    }
